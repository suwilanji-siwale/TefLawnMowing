...
*/
 ...
 /*   public static String getVersionNamePlain(Context ctx) {
  ...
  /*  public static DeviceInfo getDeviceInfo(Context context) {
        ...
        deviceInfo.device = com.material.components.utils.Tools.getDeviceName();
        deviceInfo.os_version = com.material.components.utils.Tools.getAndroidVersion();
        deviceInfo.app_version = com.material.components.utils.Tools.getVersionCode(context) + " (" + com.material.components.utils.Tools.getVersionNamePlain(context) + ")";
        deviceInfo.serial = com.material.components.utils.Tools.getDeviceID(context);
        return deviceInfo;
    }*/
