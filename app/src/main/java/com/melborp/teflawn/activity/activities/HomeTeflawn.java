...
import com.melborp.teflawn.activity.fragments.BookingsFragmentTef;
...
public class HomeTeflawn extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_teflawn);
        BottomNavigationView navigationView = findViewById(R.id.chef_bottom_navigation);
        navigationView.setOnNavigationItemSelectedListener(this);
        initToolbar();

        loadcustomerfragment(new BookingsFragmentTef());
       /* UpdateToken();
   ...
   /* private void UpdateToken() {
    ...
    private boolean loadcustomerfragment(Fragment fragment) {
        if (fragment != null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.recycler_container, fragment).commit();
            return true;
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.teflawnerHome:
                fragment = new BookingsFragmentTef();
                break;
